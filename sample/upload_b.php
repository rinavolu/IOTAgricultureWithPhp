...
class data{
 ...
 function connect(){
  ...
  mysqli_select_db($this->link,'ravindra_111') or die('Cannot select the DB');
 }
 
 function storeInDB($Temperature, $Humidity, $DustDensity, $Moisture_percentage, $Uv_level, $Uv_intensity){
  $query = "insert into node_b set Temperature='".$Temperature."', Humidity='".$Humidity."', DustDensity='".$DustDensity."', Moisture_percentage='".$Moisture_percentage."', Uv_level='".$Uv_level."', Uv_intensity='".$Uv_intensity."'";
